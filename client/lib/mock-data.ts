...
export function getMeetingByIdSync(id: string): Meeting | undefined {
...
export const recordings: Recording[] = [
  {
    id: "rec1",
    title: "Design Review – Onboarding Redesign",
    source: "live",
    status: "ready",
    createdAt: "Jun 10, 2026 · 4:00 PM",
    durationLabel: "42 min",
    team: "Design",
    summary:
      "The team reviewed the redesigned onboarding flow, focusing on the voice enrollment step and progress indicator. Saraa shared updated Figma mockups with a clearer step indicator. The team agreed to add a skip option on step two for users who want to set up voice verification later, and Oyun will double-check the Mongolian translations before the next handoff.",
    actionItems: [
      {
        id: "rec1-a1",
        text: "Add skip button to onboarding step 2",
  ...
  },
  {
    ...
    source: "live",
    status: "ready",
    createdAt: "Jun 9, 2026 · 1:00 PM",
    durationLabel: "28 min",
    team: "Marketing",
    summary:
      "Wilson walked the client through Brisk's core features: real-time MN/EN translation, AI meeting summaries, and automatic Google Workspace updates. The client asked about voice enrollment for a 40-person team and SSO. Drew will follow up with a rollout plan and Lucas will send pricing for the enterprise tier.",
    actionItems: [
      {
        id: "rec2-a1",
        text: "Send enterprise rollout plan to client",
        done: false,
        dueLabel: "Tomorrow",
      },
      {
        id: "rec2-a2",
        text: "Share enterprise pricing sheet",
        done: false,
        dueLabel: "Fri",
      },
      {
        id: "rec2-a3",
        text: "Confirm SSO support with engineering",
        done: true,
      },
    ],
    transcript: [
      {
        id: "rec2-t1",
        speaker: "Wilson Reed",
        textEn: "Thanks for joining — let's walk through Brisk's core features.",
        textMn: "Оролцсонд баярлалаа — Brisk-ийн үндсэн боломжуудыг харцгаая.",
        timestampLabel: "00:00",
      },
      {
        id: "rec2-t2",
        speaker: "Drew Bieber",
        textEn: "Real-time translation between Mongolian and English is our biggest differentiator.",
        textMn: "Монгол, англи хэлний бодит цагийн орчуулга бидний хамгийн том давуу тал юм.",
        timestampLabel: "02:10",
      },
      {
        id: "rec2-t3",
        speaker: "Lucas Brown",
        textEn: "We can scope a 40-person rollout with voice enrollment for everyone.",
        textMn: "40 хүний багт дуу хоолойн баталгаажуулалттай нэвтрэлтийг төлөвлөж болно.",
        timestampLabel: "14:32",
      },
      {
        id: "rec2-t4",
        speaker: "Wilson Reed",
        textEn: "Great, we'll send over the rollout plan and pricing by Friday.",
        textMn: "Сайн байна, бид баасан гарагт төлөвлөгөө болон үнийн санал илгээнэ.",
        timestampLabel: "26:50",
      },
    ],
  },
  {
    id: "rec3",
    title: "Sprint Retro – Sprint 24",
    source: "live",
    status: "ready",
    createdAt: "Jun 10, 2026 · 5:00 PM",
    durationLabel: "45 min",
    team: "Engineering",
    summary:
      "The team discussed wins from sprint 24, including the new participant filmstrip and recording controls. The flaky LiveKit reconnect test was identified as the main blocker and Marcus assigned it to Anna. The team agreed to add more integration tests for the translation pipeline next sprint.",
    actionItems: [
      {
        id: "rec3-a1",
        text: "Fix flaky LiveKit reconnect test",
        done: true,
      },
      {
        id: "rec3-a2",
        text: "Add integration tests for translation pipeline",
        done: false,
        dueLabel: "Next sprint",
      },
      {
        id: "rec3-a3",
        text: "Document recording controls API",
        done: false,
        dueLabel: "Mon",
      },
    ],
    transcript: [
      {
        id: "rec3-t1",
        speaker: "Marcus Chen",
        textEn: "Great sprint overall — the new filmstrip shipped on time.",
        textMn: "Энэ спринт амжилттай байсан — шинэ оролцогчдын мөр цагт нь гарсан.",
        timestampLabel: "00:00",
      },
      {
        id: "rec3-t2",
        speaker: "Anna Kim",
        textEn: "The LiveKit reconnect test is still flaky, I'll take a look.",
        textMn: "LiveKit дахин холболтын тест хэвийн биш байна, би үзье.",
        timestampLabel: "08:14",
      },
      {
        id: "rec3-t3",
        speaker: "Temuulen Ganbat",
        textEn: "We should add more integration tests for the translation pipeline.",
        textMn: "Орчуулгын дамжлагад илүү олон интеграцийн тест нэмэх хэрэгтэй.",
        timestampLabel: "21:47",
      },
      {
        id: "rec3-t4",
        speaker: "Marcus Chen",
        textEn: "Agreed, let's pick that up next sprint.",
        textMn: "Зөвшөөрч байна, дараагийн спринтэд авч үзье.",
        timestampLabel: "30:02",
      },
    ],
  },
  {
    ...
    source: "upload",
    status: "ready",
    createdAt: "Jun 8, 2026 · 11:20 AM",
    durationLabel: "1 hr 5 min",
    team: "Product",
    summary:
      "Wilson and the leads reviewed Q2 spend against budget. Marketing is slightly over due to the upcoming MN launch campaign, while engineering has headroom for an additional contractor. The team agreed to reallocate part of the analytics tooling budget toward the localization effort.",
    actionItems: [
      {
        id: "rec4-a1",
        text: "Reallocate analytics budget to localization",
        done: false,
        dueLabel: "This week",
      },
      {
        id: "rec4-a2",
        text: "Get approval for engineering contractor",
        done: false,
        dueLabel: "Next week",
      },
      {
        id: "rec4-a3",
        text: "Share updated budget sheet with leads",
        done: true,
      },
    ],
    transcript: [
      {
        id: "rec4-t1",
        speaker: "Wilson Reed",
        textEn: "Let's go through Q2 spend team by team.",
        textMn: "Q2-ийн зарцуулалтыг багаар нэг бүрчлэн харъя.",
        timestampLabel: "00:00",
      },
      {
        id: "rec4-t2",
        speaker: "Priya Shah",
        textEn: "Marketing is a bit over due to the MN launch campaign prep.",
        textMn: "Маркетинг нь Монголын зах зээлийн кампанит ажлын бэлтгэлээс шалтгаалан зарим хэмжээгээр давсан.",
        timestampLabel: "12:30",
      },
      {
        id: "rec4-t3",
        speaker: "Marcus Chen",
        textEn: "Engineering has some headroom, we could bring on a contractor.",
        textMn: "Инженерийн чиглэлд зай байгаа тул гэрээт ажилтан авч болно.",
        timestampLabel: "28:15",
      },
      {
        id: "rec4-t4",
        speaker: "Wilson Reed",
        textEn: "Let's shift some analytics budget toward localization for now.",
        textMn: "Одоохондоо анализын төсвөөс нэг хэсгийг орчуулгын ажилд шилжүүлье.",
        timestampLabel: "48:40",
      },
    ],
  },
  {
  ...
  {
    id: "rec6",
    title: "Customer Interview – Batbayar",
    source: "upload",
    status: "failed",
    createdAt: "Jun 7, 2026 · 3:30 PM",
    durationLabel: "—",
    team: "Product",
    summary: "",
    actionItems: [],
...
export function getRecordingByIdSync(id: string): Recording | undefined {
