...
export function SidebarTree() {
  ...
  return (
    <div className="mt-0.5 pl-1">
      <ul className="space-y-0">
        <li>
          <a
            href="#"
            className={cn(
              "flex items-center gap-2.5 rounded-xl px-3 py-2.5 text-[12.5px] font-semibold text-[#a78bfa] transition-colors hover:bg-muted",
            )}
          >
      ...
      <a
        href="#"
        className="mt-1 flex items-center gap-1.5 rounded-xl px-3 py-2.5 text-[12.5px] font-medium text-[#a78bfa] transition-colors hover:bg-muted hover:text-[#c4b5fd]"
      >
        <Plus className="size-3 shrink-0 stroke-[2]" />
        Create New Board
      </a>
