...
import { getNotifications, markAllNotificationsRead, markNotificationRead } from "@/lib/mock-api";
...
const typeStyles: Record<NotificationType, { icon: typeof BellIcon; className: string }> = {
  meeting: { icon: CalendarDaysIcon, className: "bg-lavender text-lavender-foreground" },
  task: { icon: ListChecksIcon, className: "bg-sage text-sage-foreground" },
  team: { icon: UsersIcon, className: "bg-tag-yellow text-tag-yellow-foreground" },
